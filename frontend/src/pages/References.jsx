...
const References = () => {
  ...
  const renderCardContent = (file) => (
    <div
      onClick={() => {
        if (editingId !== file._id) setPreview(file);
      }}
      className="group relative bg-white dark:bg-slate-900 p-10 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-indigo-500 transition-all shadow-md hover:shadow-2xl cursor-pointer flex flex-col justify-between min-h-[240px] h-full"
    >
      <div>
        <div className="flex justify-between items-start mb-6">
          <div className="flex items-center gap-3">
            {isAdmin && (
              <div className="text-slate-400 hover:text-indigo-500 cursor-grab active:cursor-grabbing">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-700 dark:text-slate-400 mt-1 font-medium">
                Curated technical assets for your growth
              </p>
            </div>
          </div>
