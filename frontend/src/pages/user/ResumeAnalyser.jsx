...
function ResumeAnalyser() {
  ...
  return (
    <div className="min-h-screen pb-12 sm:pb-16 bg-linear-to-br from-amber-50/70 via-orange-50/40 to-yellow-50/70 dark:from-slate-950 dark:via-indigo-950/40 dark:to-slate-950 px-4 sm:px-6">
       <div className="max-w-6xl mx-auto pt-10 sm:pt-14">
        ...
        <div className="bg-white dark:bg-slate-900/90 backdrop-blur-md rounded-2xl sm:rounded-3xl shadow-xl border border-orange-100 dark:border-slate-800 p-5 sm:p-10 mb-8 sm:mb-12">
          ...
          <div className="flex flex-col gap-3.5 sm:flex-row sm:gap-4 justify-between items-center">
            ...
            <button
              ...
              disabled={loading}
              className="w-full sm:w-auto h-14 px-8 text-sm sm:text-base font-bold rounded-xl sm:rounded-2xl text-white bg-linear-to-r from-orange-500 to-red-500 hover:shadow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shrink-0"
            >
              {loading ? (
                <>
        ...
        {!loading && analysisResult && (
          <div className="w-full bg-white dark:bg-slate-900 rounded-2xl sm:rounded-3xl shadow-xl border border-orange-200/60 dark:border-slate-800 p-5 sm:p-10 transition-all duration-500 space-y-6 sm:space-y-8">
            ...
            <div className="bg-linear-to-r from-orange-500 via-orange-600 to-red-500 rounded-2xl sm:rounded-3xl p-6 sm:p-8 text-center text-white shadow-md max-w-xs mx-auto">
