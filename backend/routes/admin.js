...
import { getStats, getUsers,getReferences, addReferences,deleteReference } from "../controllers/admin.js";
...
router.get("/references", protect, adminProtect, getReferences);
